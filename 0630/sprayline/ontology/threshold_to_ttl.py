...
def convert_csv_to_ttl(csv_path: Path, ttl_path: Path) -> None:
    ...
    lines.append('    sl:sourceFile "ontology/threshold_reference.csv" ;')
    lines.append('    sl:version "0623ver_2" .')
    lines.append("")
...
def main() -> None:
    ...
    parser.add_argument("--csv", default="ontology/threshold_reference.csv")
