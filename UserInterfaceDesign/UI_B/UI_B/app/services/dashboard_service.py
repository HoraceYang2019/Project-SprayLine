...
COMPONENTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status_metrics": ["temperature_c", "humidity_rh"],
        "value_label": "膜厚",
        "unit": "µm",
    },
]
...
class DashboardService:
    ...
    def dashboard_payload(self, slider_value: float = 0, mode: str = "time") -> dict[str, Any]:
        ...
        for station_id in STATIONS:
            timestamp, raw = self.data.station_at(station_id, slider_value=slider_value, mode=mode)
        ...
        if mode == "batch":
            display_label = "目前批次" if slider_value == 0 else (f"過去第{abs(int(slider_value))}批" if slider_value < 0 else f"未來第{int(slider_value)}批")
        else:
        ...
        return {
            "schema_version": "ui_v6_local_v1",
            "service_name": "UI_V6_LocalIntegratedService",
            "generated_at": datetime.now().astimezone().isoformat(),
            "source_type": "LocalDemoUsingShaoYu0616_B_Contract",
            ...
            "viewer_state": {
                ...
                "selected_time": selected_time.isoformat() if selected_time else None,
    ...
    def component_detail(self, station_id: str, component_key: str, slider_value: float = 0, mode: str = "time") -> dict[str, Any]:
        _, raw = self.data.station_at(station_id, slider_value=slider_value, mode=mode)
        ...
        return {
            ...
            "component": component,
            "detail_function": "UI_V6LocalComponentDetail",
            "detail_source": "少榆0616_B版 threshold/mapping + UI_V6 local diagnosis catalog",
        }

    def station_detail(self, station_id: str, slider_value: float = 0, mode: str = "time") -> dict[str, Any]:
        _, raw = self.data.station_at(station_id, slider_value=slider_value, mode=mode)
        station = self.build_station(station_id, raw)
        ...
        return {
            ...
            "issues": issues,
            "detail_function": "UI_V6LocalStationDetail",
            "detail_source": "少榆0616_B版 threshold/mapping + UI_V6 local diagnosis catalog",
        }
    ...
    def trend_payload(self, station_id: str, component_key: str) -> dict[str, Any]:
        ...
        return {
            ...
            "source": "UI_V6 local time-series following 少榆0616_B版 UI output contract",
        }
