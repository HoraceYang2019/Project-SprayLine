...
<#
.SYNOPSIS
    SprayLine final_version_0717 — Docker startup script
...
function Invoke-Start {
    Write-Header "Start 0717 Services (existing 0627 database)"
    ...
    Write-Warn "0717 is configured for final_version_0627_sprayline_pgdata."
...
switch ($Mode) {
    ...
    "reset"   { Invoke-Validate; Write-Fail "Reset is disabled in 0717 to protect final_version_0627_sprayline_pgdata."; exit 1 }
