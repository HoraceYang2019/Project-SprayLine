...
class DashboardService:
    ...
    def dashboard_payload(self, slider_value: float = 0, mode: str = "time") -> dict[str, Any]:
        ...
        component_route_expected = 0  # component-detail is lazy in 0717
        ...
        for ui_id in STATIONS:
            ...
            try:
                ...
                # 0717 performance fix: station-detail already contains the six
        ...
        # 0717: the database clock is the only data-time source.  The previous
