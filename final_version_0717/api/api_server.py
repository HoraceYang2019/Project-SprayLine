...
app = FastAPI(
    title="SprayLine API final_version_0715",
    description=(
...
def GetRoutes():
    ...
    return {"service_name": "SprayLine_API_0715", "route_count": len(routes), "routes": routes}


@app.get("/")
def HealthCheck():
    return {
        "service_name": "SprayLine API final_version_0715",
        "version": "0715.0",
        "status": "running",
