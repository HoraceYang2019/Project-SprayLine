...
- The existing DB table stores only the legacy summary fields. The full `predicted_metrics` object is currently returned through the API response but is not persisted as separate DB columns.
