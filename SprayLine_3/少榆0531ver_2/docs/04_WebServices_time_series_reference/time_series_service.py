...
class TimeSeriesService:
    ...
    def CalculateNozzleMetrics(self, p):
        return {
            ...
            "nozzle_clog_rate_pct": self.CalculateClogRateFromNominalFlow(p.get("flow_rate_ml_min"), p.get("nominal_flow_rate_ml_min")),
