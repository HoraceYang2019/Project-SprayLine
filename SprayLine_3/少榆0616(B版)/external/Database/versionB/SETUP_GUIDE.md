# Database/versionB SETUP GUIDE（少榆0616ver_4 對齊版）

本檔是少榆0616ver_4 隨包附上的 `Database/versionB` reference copy 使用說明。
...
如果從 `SprayLine_3/少榆0616ver_4` 執行，adapter 會依序尋找：

```text
1. SPRAYLINE_DB_FUNCTION_PATH
2. SPRAYLINE_PROJECT_ROOT/Database/versionB
3. 少榆0616ver_4/external/Database/versionB
...
0616ver_4 不新增 HTTP 對外路由，不新增 FastAPI / API server。
