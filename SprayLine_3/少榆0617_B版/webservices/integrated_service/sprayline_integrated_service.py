...
class IntegratedSprayLineService:
    ...
    def build_ui_time_series_response(self, conn, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        requested_metrics = request.get("requested_metrics", DEFAULT_REQUESTED_METRICS)
        ...
        window = self.build_time_window(slider_value=slider_value, window_minutes=window_minutes)
